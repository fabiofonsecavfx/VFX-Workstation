...
keys = [
    ...
    # Rofi
    Key([mod], "r", lazy.spawn("rofi -show drun"), desc="Launch rofi app launcher"),
    Key(
        [mod, "shift"], "r", lazy.spawn("rofi -show run"), desc="Launch rofi run dialog"
    ),
    Key(
        [mod],
        "Tab",
